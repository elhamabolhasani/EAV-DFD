...
class Loss(nn.Module):
    ...
    def forward(self, anchor):
        ...
        a_tea_fus_qk, a_stu_fus_qk, a_tea_fus_vv, a_stu_fus_vv = self._preprocess_qkv_layer_selection(anchor, w_softmax=True)

        loss = self.kl_div(a_stu_fus_vv.log(), a_tea_fus_vv)
