...
parser.add_argument('--batch_size', help='Single GPU Face detection batch size', default=6, type=int)
parser.add_argument("--data_root", default=config.fakeavceleb_dataset)
parser.add_argument("--preprocessed_root", default=config.preprocess_dataset)
